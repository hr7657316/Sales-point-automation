...
REP_NAMES = {
    ...
    "M1-11-3": ("Zach Schneider", "SCHNEIDER"),
    "M1-11-31": ("Samir Thapa", "THAPA"),
    "M1-11-38": ("Brendon Hink", "HINK"),
    ...
    "M1-21-70": ("Carlo DeAngelo (Sales Associate - no commission yet)", None),
}
...
CATEGORY_LABELS = {
    ...
    "MZ_ATTORNEY_LIEN": "1 MZ Medicare/Auto/Tricare-USDL/Medicaid/Commercial",
    ...
    "ANC_TCT_AUTO": "ANCILLARY: 1 TCT Auto",
}
